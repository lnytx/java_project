...
/*
 * 属性哪里来
 * 1、t_user表：因为我们需要t_user表查询出的数据封装到User对象中
...
public class User
{
	...
	private boolean status;//状态，true表示已激活，false未激活
	private String activationCode;//激活码，它是唯一值，即每个用户的激活是不同的
	//注册表单
	private String reloginpass;//确认密码
	private String verifyCode;//验证码
	//修改密码表单
	private String newpass;//修改密码时的新密码
